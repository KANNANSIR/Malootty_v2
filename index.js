...
Ruri.logger.level = 'warn'
   ...
   qrcode.generate(qr, { small: true })
	console.log(color('(+)','white'), color('Malootty','red'), color('(+)','white'), color(' SQAN THE CODE','aqua'), color('MaloottyOFC','yellow'))
})
	...
	Ruri.on('open', () => {
		success('2', color('[ ! ]connected\n','red'), color('SCRIPT BY KRISHNADAS','yellow'))
	})
...
//MENU
                ...
                wew = fs.readFileSync('./lib/Malootty.jpg')
                uptime = process.uptime()
                teks = `${kyun(uptime)}`
...
Ruri.sendMessage(from, wew, image, { quoted: { key: { fromMe: true, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage":{"product":{"productImage":{"mimetype":"image/jpeg","height":736,"width":736,"jpegThumbnail":fs.readFileSync(`./lib/Malootty.jpg`)},"productId":"3937202479680283","title":"Malootty","currencyCode":"IDR","priceAmount1000":"10000","productImageCount":1},"businessOwnerJid":"0@s.whatsapp.net"}}}, caption: Chan })
                ...
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, tlsm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
                break
				case 'ownermenu':
                if (!isVerify) return reply(aml.noregis)
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, ownm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
                break
                case 'downloadmenu':
                if (!isVerify) return reply(aml.noregis)
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, dwm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
                case 'funmenu':
                if (!isVerify) return reply(aml.noregis)
                if (isLimit(sender)) return reply(aml.limitend)
                if (isBanned) return reply(aml.baned)
                Ruri.sendMessage(from, funm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
			    case 'groupmenu':
			    case 'grupmenu':
			    if (!isVerify) return reply(aml.noregis)
			    if (isLimit(sender)) return reply(aml.limitend)
			    if (isBanned) return reply(aml.baned)
			    Ruri.sendMessage(from, grpm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
			    case 'allmenu':
			    case 'fullmenu':
			    case 'listmenu':
			    ...
			    if (isLimit(sender)) return reply(aml.limitend)
			    if (isBanned) return reply(aml.baned)
			    Ruri.sendMessage(from, allm(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
			    case 'script':
			    case 'sc':
			    case 'git':
			    ...
			    if (isLimit(sender)) return reply(aml.limitend)
			    if (isBanned) return reply(aml.baned)
			    Ruri.sendMessage(from, scrpt(), text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
			    break
                case 'stiker': 
				case 'sticker':
				case 's':
...
case 'ytmp4':
			...
			axios.get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
			.then((a) => {
			if (Number(filesize) >= 10000) return sendFileFromUrl(from, thumb, `┌───〔 *𝐌𝐀𝐋𝐎𝐎𝐓𝐓𝐘_𝐕𝟐* 〕\n┊\n└───────────𔒝\n┌───〔 ʏᴛᴍᴘ𝟺 〕\n┊\n┊ᴛɪᴛʟᴇ : ${title}\n┊ғᴏʀᴍᴀᴛ : MP4\n┊ғɪʟᴇsɪᴢᴇ : ${filesizeF}\n┊ʟɪɴᴋ : ${a.data}\n┊\n┊ᴛʜᴇ ғɪʟᴇ ɪs ᴍᴏʀᴇ ᴛʜᴀɴ ᴛʜᴇ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ,\n┊ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴍᴀɴᴜᴀʟʟʏ ғʀᴏᴍ ᴛʜᴇ ᴀʙᴏᴠᴇ ʟɪɴᴋ\n└───────────𔒝`)
			const captionsYtmp4 = `┌───〔 *𝐌𝐀𝐋𝐎𝐎𝐓𝐓𝐘_𝐕𝟐* 〕\n┊\n└───────────𔒝\n┌───〔 ʏᴛᴍᴘ𝟺 〕\n┊\n┊ᴛɪᴛʟᴇ : ${title}\n┊ғᴏʀᴍᴀᴛ : MP4\n┊sɪᴢᴇ : ${filesizeF}\n┊\n┊ᴘʟᴇᴀsᴇ ʙᴇ ᴘᴀᴛɪᴇɴᴛ,\n┊ᴛʜᴇ ғɪʟᴇ ɪs ʙᴇɪɴɢ ᴜᴘʟᴏᴀᴅᴇᴅ\n└───────────𔒝`
...
case 'setmenu':
				...
				Ruri.sendMessage(from, 'sᴜᴄᴄᴇssғᴜʟʟʏ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇ ɢʀᴏᴜᴘ ɴᴀᴍᴇ', text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
				break
                case 'setdesc':
                if (!isGroup) return reply(aml.groupo)
                if (!isBotGroupAdmins) return reply(aml.badmin)
                ...
                Ruri.sendMessage(from, 'sᴜᴄᴄᴇssғᴜʟʟʏ ᴄʜᴀɴɢᴇᴅ ᴛʜᴇ ɢʀᴏᴜᴘ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ', text, { thumbnail: fs.readFileSync('./lib/logo.jpg'), caption: 'Malootty', "contextInfo": { text: 'hi', sendEphemeral: true, "externalAdReply": { "title": `${''}${tampilUcapan}${' '}${pushname}${''}`, "body": `${'https://youtube.com/c/JZMODS'}`, "previewType": 'PHOTO', "thumbnailUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://b.top4top.io/s_2024uih200.jpg'}`}},quoted: fkontak})
                break
                case 'demote':
                if (!isGroup) return reply(aml.groupo)
                if (!isBotGroupAdmins) return reply(aml.badmin)
...
/*========================================================*/
				...
				default:
	if (budy.includes('Malootty')){
	Ruri.sendMessage(from, `ɪᴛs ᴍᴇ ᴍᴀʟᴏᴏᴛᴛʏ, ʜᴏᴡ ᴄᴀɴ ɪ ʜᴇʟᴘ ʏᴏᴜ?🎀`, text, { sendEphemeral: true, thumbnail: fs.readFileSync('./lib/logo.jpeg', 'base64')}) 			
    break
}
	if (budy.includes('Malootty')){
	Ruri.sendMessage(from, `ɪᴛs ᴍᴇ ᴍᴀʟᴏᴏᴛᴛʏ, ʜᴏᴡ ᴄᴀɴ ɪ ʜᴇʟᴘ ʏᴏᴜ?🎀`, text, { sendEphemeral: true, thumbnail: fs.readFileSync('./lib/logo.jpeg', 'base64')}) 			
